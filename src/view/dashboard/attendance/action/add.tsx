...
export default function AddAttendance({ callback } : { callback: () => void })
{
    ...
    const [formData, setFormData] = useState<Attendance>({
        ...
        durasi: '',
        deskripsi: '',
        justifikasi_approval: null,
        justifikasi_agenda: null,
    });
    ...
    const handleFormSubmit = (e: FormEvent<HTMLFormElement>) => {
        try 
        {
            ...
            attendance.create(formData).then((response) => {
                if (response?.success)
                {
                    toast.success('Attendance', response.message);
                    notification.success('Attendance', 'You have successfully checked attendance');
                }
                else
                {
